...
G4VPhysicalVolume* B1DetectorConstruction::Construct()
{
  ...
  */
  ...
  //1x plate
  G4Box* oneXPlateBox = new G4Box("oneXPlateBox", voxelDim/2.,
				  voxelDim/2., voxelThicc/2.);
  //std::cout << "test\n";
  G4LogicalVolume* oneXPlateLog = new G4LogicalVolume(oneXPlateBox,
						      GAGGCe, "oneXPlateLog");
  //std::cout << "test\n";
  new G4PVPlacement(0, G4ThreeVector(0,0,0), oneXPlateLog, "oneXPlatePlace",
		    logicWorld, false, 0);
  
  //2x plate
  G4Box* twoXPlateBox = new G4Box("twoXPlateBox", voxelDim/2.,
				  voxelDim/2., voxelThicc);
  G4LogicalVolume* twoXPlateLog = new G4LogicalVolume(twoXPlateBox,
						      GAGGCe, "twoXPlateLog");
  new G4PVPlacement(0, G4ThreeVector(0,0,11.), twoXPlateLog, "twoXPlatePlace",
		    logicWorld, false, 0);

  G4Tubs* bigBrassTubs = new G4Tubs("bigBrassTubs", 5.5/2., 38./2.,
				    25.4/2., 0., 2*M_PI);
  ...
  //
  fScoringVolume = oneXPlateLog;
  fScoringVolume2 = twoXPlateLog;
