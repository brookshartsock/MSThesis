...
void DetectorConstruction::DefineMaterials()
{
 ...
 LSO->AddElement(O , 5);
  ...
  G4Element* eAl = new G4Element("eAluminum", "eAl", z = 13, a = 26.98*g/mole);
  ...
  G4Material* GAGGCe = new G4Material("GAGGCe", density=6.63*g/cm3,5);
  GAGGCe -> AddElement(Ce, 1);
  GAGGCe -> AddElement(Gd, 3);
  GAGGCe -> AddElement(eAl, 2);
  GAGGCe -> AddElement(Ga, 3);
  GAGGCe -> AddElement(O, 12);

  G4Material* PVT = new G4Material("PVT", density=1.05*g/cm3,2);
  PVT -> AddElement(C, 9);
  PVT -> AddElement(H, 10);
  ...
  G4Material* TGP = new G4Material("TGP", density = 3.7*g/cm3,5);
  TGP -> AddElement(Na, 21);
  TGP -> AddElement(P, 11);
  TGP -> AddElement(O, 65);
  TGP -> AddElement(Ga, 8);
  TGP -> AddElement(W, 5);
  ...
  G4Material* BaFF = new G4Material("BaFF", density = 4.88*g/cm3,2);
  BaFF -> AddElement(F, 2);
  BaFF -> AddElement(Ba, 1);

  G4Element* Li = new G4Element("Lithium", "Li", z = 3, a = 7.0*g/mole);
  G4Element* In = new G4Element("Indium", "In", z = 49, a = 114.818*g/mole);
  G4Element* Se = new G4Element("Selenium", "Se", z = 34, a = 78.97*g/mole);
  G4Material* LiInSe = new G4Material("LiInSe", density = 4.47*g/cm3,3);
  LiInSe -> AddElement(Li, 1);
  LiInSe -> AddElement(In, 1);
  LiInSe -> AddElement(Se, 2);
