...
#ifndef LXePMTSD_h
#define LXePMTSD_h 1
//#ifndef LXE_DETECTOR_CONSTRUCTION_HH
//#define LXE_DETECTOR_CONSTRUCTION_HH
...
private:
  ...
  //LXeDetectorConstruction::voxelSpecifics PMTSDhh;
  //const int cubeNum = PMTSDhh.voxelNum;
  double SiPMDiffRatio[64];
  int SiPMCount0[64];
  int SiPMCount1[64];
};
