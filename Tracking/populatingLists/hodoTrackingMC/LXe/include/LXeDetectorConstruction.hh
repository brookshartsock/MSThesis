...
class LXeDetectorConstruction : public G4VUserDetectorConstruction
{
  ...
  struct voxelSpecifics{
    G4double voxelDim = 1.;//7.
    G4double voxelThicc = 16.;//1.
    G4double voxelSpace = 0.01;//2., for aluminum thickness?????
    G4int voxelNum = 16;//16
    bool inlin3 = 1; //1 for inline 0 for offset
  };
